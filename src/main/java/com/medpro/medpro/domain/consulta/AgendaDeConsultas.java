package com.medpro.medpro.domain.consulta;
...
public class AgendaDeConsultas {
    ...
    // OCP: Injeção de uma lista de validadores. Para adicionar nova regra, basta criar nova classe, sem mexer aqui.
    @Autowired
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados) {
        ...
        // SOLID: OCP em ação (Open-Closed Principle)
